...
async function deployContract(api, txqueue, pair, contract, clusterId, skipCheck) {
    console.log(`Contracts: uploading ${contract.name}, hash=${contract.metadata.source.hash}`);
    // upload the contract 
